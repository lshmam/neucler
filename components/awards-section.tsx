...
const badges = [
  { title: "Leader", subtitle: "Results", color: "bg-terracotta" },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              #1 in AI Agents for Business
              <br />
              <em className="font-serif italic">Operations</em>
            </h2>
            <p className="text-lg text-muted-foreground mb-2">In Results, Implementation, and Support.</p>
          ...
          <div className="flex flex-wrap justify-center lg:justify-end gap-4">
            {badges.map((badge, index) => (
              <div
                key={index}
                className={`${badge.color} text-white rounded-2xl p-6 w-32 h-40 flex flex-col items-center justify-center`}
              >
